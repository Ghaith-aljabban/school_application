      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                Center(child: Icon(Icons.account_circle,size: 140,color: myGreen,)),
                SizedBox(height: 10,),
                Center(child: Text(ghaith.firstName+' '+ghaith.lastName,style: headerTextStyle,)),
                SizedBox(height: 20,),
              ],
            ),
          ),
          ...
          Center(child: Container(width:300,height:1.3,color: myGray,)),
          SizedBox(height: 15,),
          dataField(fieldName: 'Student phone number', data: ghaith.studentNumber),
          SizedBox(height: 15,),
          Center(child: Container(width:300,height:1.3,color: myGray,)),
          SizedBox(height: 15,),
          ...
          Center(child: Container(width:300,height:1.3,color: myGray,)),
          SizedBox(height: 15,),
          dataField(fieldName: 'Parrent phone number', data: ghaith.parentNumber),
          SizedBox(height: 15,),
          Center(child: Container(width:300,height:1.3,color: myGray,)),
