...
import 'package:school_application/modules/welcome/welcome_screen2.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Center(
            child: SvgPicture.asset('assets/SVGs/welcome SVGs/welcome 1.svg'
