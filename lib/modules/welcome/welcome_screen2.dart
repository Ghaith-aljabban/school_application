...
import 'package:school_application/modules/welcome/welcome_screen3.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Center(
            child: SvgPicture.asset('assets/SVGs/welcome SVGs/welcome 2.svg'
              ,height: 255,width: 323,),
          ),
          SizedBox(
            height: 70,
          ),
